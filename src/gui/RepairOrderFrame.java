...
//                shipTypeComboBox.addItem(shipTypeList.get(i).toString());
    ...
    private void initComponents() {
        ...
        ROAddButton.setNextFocusableComponent(ROUpdateButton);

        ROUpdateButton.setText("Update");
        ROUpdateButton.setNextFocusableComponent(RORemoveButton);

        RORemoveButton.setText("Remove");
        RORemoveButton.setNextFocusableComponent(ROResetButton);
        ...
        workEID4ComboBox.setNextFocusableComponent(ROAddButton);
